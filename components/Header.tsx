  ...
  return (
    <header className="px-8 py-6 md:px-16 lg:px-24 border-b border-[#282828]">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <button type="button" className="group flex items-center gap-2 rounded-lg bg-[#FFC799] px-4 py-2 text-sm font-medium text-[#000] transition-all hover:bg-[#FFCFA8] hover:shadow-lg hover:shadow-[rgba(255,199,153,0.3)]">
